...
ActiveRecord::Schema.define(version: 20170823062315) do
  ...
  create_table "credentials", force: :cascade do |t|
    ...
    t.string   "private_key_file_name"
    t.string   "private_key_content_type"
    t.integer  "private_key_file_size"
    t.datetime "private_key_updated_at"
